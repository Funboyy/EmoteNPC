...
public class ToggleLookCloseSubCommand implements SubCommand {

    private static final List<String> COMMANDS = Arrays.asList("lookclose", "look");
    ...
    public void onCommand(final CommandSender sender, final String[] args) {
        ...
        sender.sendMessage(Config.COMMAND_TOGGLE_LOOK_CLOSE.get());
    }
